...
const key_override_t ctl_space_override = ko_make_basic(KC_LCTL, KC_SPC, KC_UNDS);
 ...
 */
 ...
 [_SL] = LAYOUT_planck_grid(
     XXXXXXX,  KC_TILD, KC_AT  , KC_HASH, KC_DLR , KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_EXLM, XXXXXXX, XXXXXXX,
     XXXXXXX,  KC_GRV , KC_EQL , KC_LT  , KC_GT  , KC_QUOT, KC_BSLS, KC_LCBR, KC_RCBR, KC_PIPE, XXXXXXX, XXXXXXX,
     AL     ,  KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_DQUO, KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC, XXXXXXX, XXXXXXX,
     XXXXXXX,  XXXXXXX, XXXXXXX, OSM_ALT, BL     , OSM_SFT, OSM_CTL, XXXXXXX, NL     , XXXXXXX, XXXXXXX, XXXXXXX
 ),

 [_NL] = LAYOUT_planck_grid(
     XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MINS, KC_7   , KC_8   , KC_9   , XXXXXXX, XXXXXXX,
     XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, KC_UNDS, KC_PLUS, KC_EQL , KC_4   , KC_5   , KC_6   , XXXXXXX, XXXXXXX,
     AL     ,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DOT , KC_0   , KC_1   , KC_2   , KC_3   , XXXXXXX, XXXXXXX,
